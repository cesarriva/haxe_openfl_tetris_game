 ...
 * @author Cesar Riva
 */
class IRotation implements IRotationShape
{
	public function new() 
	{
	...
	public function setOneQuarterRotation(shape:BaseShape):Void 
	{
		...
		shape.Blocks.set(3, new Block((currentX - 1), (currentY + 1)));
	}
	...
	public function setHalfRotation(shape:BaseShape):Void 
	{
		...
		shape.Blocks.set(0, new Block((currentX - 2), (currentY + 2)));
		shape.Blocks.set(1, new Block((currentX - 2), (currentY + 1)));
		shape.Blocks.set(2, new Block((currentX - 2), currentY));
		shape.Blocks.set(3, new Block((currentX - 2), (currentY - 1)));
	}
	...
	public function setThreeQuarterRotation(shape:BaseShape):Void
	{
		...
		shape.Blocks.set(1, new Block(currentX, (currentY - 2)));
		shape.Blocks.set(2, new Block((currentX + 1), (currentY - 2)));
		shape.Blocks.set(3, new Block((currentX + 2), (currentY - 2)));
	}
