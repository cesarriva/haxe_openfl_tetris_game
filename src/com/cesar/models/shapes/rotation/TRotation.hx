 ...
 * @author Cesar Riva
 */
class TRotation implements IRotationShape
{
	public function new() 
	{
	...
	public function setOneQuarterRotation(shape:BaseShape):Void 
	{
		...
		shape.Blocks.set(2, new Block((currentX + 2), (currentY + 2)));
	...
	public function setHalfRotation(shape:BaseShape):Void 
	{
		...
		shape.Blocks.set(0, new Block(currentX, (currentY + 2)));
	...
	public function setFullRotation(shape:BaseShape):Void 
	{
		...
		shape.setDefaultShapePosition(currentX, (currentY - 2));
	}
