 ...
 * @author Cesar Riva
 */
class SquareRotation implements IRotationShape
{
	public function new() { }
	...
	public function setOneQuarterRotation(shape:BaseShape):Void
	{
		...
		shape.Blocks.set(0, new Block((currentX + 1), currentY));
	...
	public function setHalfRotation(shape:BaseShape):Void
	{
		...
		shape.Blocks.set(0, new Block(currentX, (currentY + 1)));
		shape.Blocks.set(1, new Block((currentX - 1), (currentY + 1)));
		shape.Blocks.set(2, new Block(currentX, currentY));
		shape.Blocks.set(3, new Block((currentX - 1), currentY));
	}
	...
	public function setFullRotation(shape:BaseShape):Void
	{
		...
		shape.setDefaultShapePosition(currentX, (currentY - 1));
	}
}